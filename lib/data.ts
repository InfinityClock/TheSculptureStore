...
export const PRODUCTS: Product[] = [
  ...
  {
    id: '9',
    name: 'Lord Krishna - Divine Flute',
    slug: 'krishna-flute',
    price: 3499,
    originalPrice: 4599,
    discount: 24,
    rating: 4.9,
    reviews: 142,
    image: '/images/products/krishna-flute.png',
    images: ['/images/products/krishna-flute.png'],
    category: 'divine-idols',
    material: 'Bronze-finished Resin',
    sizes: ['10 inch', '15 inch'],
    badge: 'Trending',
    description: 'A beautifully detailed sculpture of Lord Krishna playing his divine flute, symbolizing peace, love, and harmony.',
    inStock: true,
    featured: false,
  },
  {
    id: '10',
    name: 'Mahatma Gandhi - Bust',
    slug: 'gandhi-bust',
    price: 2899,
    originalPrice: 3899,
    discount: 25,
    ...
    images: ['/images/products/gandhi-bust.png'],
    category: 'monuments',
    material: 'Bronze-finished Resin',
    sizes: ['6 inch', '9 inch'],
    description: 'A realistic, highly detailed 3D printed bust of the Father of the Nation, Mahatma Gandhi. Perfect for offices and institutions.',
    inStock: true,
    featured: false,
  },
  {
    id: '11',
    name: 'Hanuman - Dashboard Mini',
    slug: 'hanuman-dashboard',
    price: 699,
    originalPrice: 999,
    discount: 30,
    rating: 4.9,
    reviews: 412,
    image: '/images/products/hanuman-dashboard.png',
    images: ['/images/products/hanuman-dashboard.png'],
    category: 'car-dashboard',
    material: 'Premium Matte Resin',
    sizes: ['3.5 inch', '5 inch'],
    badge: 'Bestseller',
    description: 'A cute, vibrant miniature of Lord Hanuman specifically designed with an adhesive base for car dashboards.',
    inStock: true,
    featured: true,
  },
  {
    id: '12',
    name: 'Nandi Bull - Temple Miniature',
    slug: 'nandi-statue',
    price: 1599,
    originalPrice: 2199,
    discount: 27,
    rating: 4.7,
    reviews: 54,
    image: '/images/products/nandi-statue.png',
    images: ['/images/products/nandi-statue.png'],
    category: 'temple-decor',
    material: 'Stone-finished Resin',
    sizes: ['5 inch', '8 inch'],
    description: 'A stunning stone-finished replica of Nandi the bull, an essential piece for any South Indian temple-style decor.',
    inStock: true,
    featured: false,
  },
  {
    id: '13',
    name: 'The Endless Knot - Abstract',
    slug: 'minimal-knot',
    price: 4599,
    originalPrice: 5999,
    discount: 23,
    rating: 4.8,
    reviews: 110,
    image: '/images/products/minimal-knot.png',
    images: ['/images/products/minimal-knot.png'],
    category: 'home-decor',
    material: 'Matte Beige Resin',
    sizes: ['8 inch', '12 inch'],
    badge: 'Designer Choice',
    description: 'A modern, elegant abstract knot sculpture. Its soft beige matte finish blends beautifully into contemporary minimal decor.',
    inStock: true,
    featured: false,
  },
]
