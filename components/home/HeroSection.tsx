  ...
  return (
    ...
    >
      ...
      <div className="container-wide relative z-10">
        ...
        {/* ── Mobile layout ── */}
        <div className="lg:hidden pt-20 pb-12 flex flex-col">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 rounded-full border border-tss-peach/25 bg-tss-peach/10 px-4 py-1.5 w-fit mb-5">
          ...
          <h1 className="font-display text-4xl font-bold text-white leading-[1.15] mb-4">
            Turn Your Faith Into{' '}
            <span className="peach-text">3D Art</span>
          </h1>

          <p className="text-white/55 text-base leading-relaxed font-body mb-3">
          ...
          <p className="text-tss-peach/90 font-display font-semibold text-sm mb-7">
            Starting from ₹699 · 14–21 day delivery · 50+ countries
          </p>

          <div className="flex flex-col gap-3 mb-8">
            <Link href="/shop" className="btn-peach justify-center">
            ...
            <a
              ...
              className="btn-white-outline justify-center"
            >
          ...
          <div className="flex flex-wrap gap-2.5">
            {[
              ...
              <div key={text} className="flex items-center gap-2 glass-dark rounded-full px-3 py-2">
                <Icon size={12} className="text-tss-peach shrink-0" />
                <div>
        ...
        {/* ── Desktop layout ── */}
        <div className="hidden lg:grid lg:grid-cols-2 gap-16 items-center min-h-screen py-0">
          {/* Left copy */}
          <div className="flex flex-col">
            ...
            <h1 className="font-display text-5xl lg:text-6xl font-bold text-white leading-[1.15] mb-5">
              Turn Your Faith Into{' '}
              <span className="peach-text">3D Art</span>
            </h1>

            <p className="text-white/55 text-lg leading-relaxed max-w-lg font-body mb-3">
              Hand-sculpted divine idols, custom portraits, monuments & more, crafted with precision and delivered to your door anywhere in the world.
            </p>
          ...
          <div className="relative flex items-center justify-center">
            ...
            <div className="relative w-full max-w-[400px]">
              ...
              <div className="absolute -top-4 -right-4 glass-dark rounded-2xl px-3.5 py-2.5 animate-float" style={{ animationDelay: '1s' }}>
              ...
              <div className="absolute -bottom-4 -left-4 glass-dark rounded-2xl px-3.5 py-2.5 animate-float" style={{ animationDelay: '2.5s' }}>
      ...
      <div className="hidden lg:flex absolute bottom-8 left-1/2 -translate-x-1/2 flex-col items-center gap-1.5 animate-bounce">
