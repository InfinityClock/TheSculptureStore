...
export default function Footer() {
  return (
    <footer style={{ backgroundColor: '#0D1E2E' }} className="text-white">
      <div className="container-wide px-6 sm:px-8 py-14">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-12">
            ...
            <div className="flex gap-2.5 mt-1">
              {[
                ...
                <a key={label} href={href} target="_blank" rel="noopener noreferrer" aria-label={label}
                  className="w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center text-white/55 hover:text-white transition-all">
          ...
          <div className="grid grid-cols-2 gap-x-16 gap-y-8">
            <div>
              <h4 className="font-display font-bold text-white text-sm mb-5">Company</h4>
            ...
            <div>
              <h4 className="font-display font-bold text-white text-sm mb-5">Support</h4>
              <ul className="flex flex-col gap-3">
                {[
                  ['Our Products', '/shop'],
