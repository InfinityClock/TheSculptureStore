...
export default function Footer() {
  return (
    <footer style={{ backgroundColor: '#0D1E2E' }} className="text-white">
      ...
      <div className="container-wide px-6 sm:px-8 pt-16 pb-10">
        ...
        <div className="flex gap-3 mb-12">
          {[
            ...
            <a key={label} href={href} target="_blank" rel="noopener noreferrer" aria-label={label}
              className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center text-white/55 hover:text-white transition-all">
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-10">
          <div>
            <h4 className="font-display font-bold text-white text-sm tracking-wide mb-5">Company</h4>
            <ul className="flex flex-col gap-3.5">
              {[
                ...
                <li key={label}>
                  <Link href={href} className="text-sm text-white/45 hover:text-tss-peach transition-colors font-body leading-none">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h4 className="font-display font-bold text-white text-sm tracking-wide mb-5">Support</h4>
            <ul className="flex flex-col gap-3.5">
              {[
                ['Our Products', '/shop'],
      ...
      {/* Copyright */}
      <div className="container-wide px-6 sm:px-8 pb-8 pt-10">
